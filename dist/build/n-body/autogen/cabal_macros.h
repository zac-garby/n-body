...
/* package n-body-0.1.0.0 */
#ifndef VERSION_n_body
#define VERSION_n_body "0.1.0.0"
#endif /* VERSION_n_body */
#ifndef MIN_VERSION_n_body
#define MIN_VERSION_n_body(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_n_body */
...
#define CURRENT_COMPONENT_ID "n-body-0.1.0.0-9cXmKXFNWdxDfnyEZPvoFI-n-body"
